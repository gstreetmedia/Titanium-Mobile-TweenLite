...
(Alloy.Globals._gsQueue || (Alloy.Globals._gsQueue = [])).push( function() {

	"use strict";

	Alloy.Globals._gsDefine("easing.Back", ["easing.Ease"], function(Ease) {
		
		var w = (Alloy.Globals.GreenSockGlobals || Alloy.Globals),
			gs = w.com.greensock,
			_2PI = Math.PI * 2,
			_HALF_PI = Math.PI / 2,
			_class = gs._class,
...
if (Alloy.Globals._gsDefine) { Alloy.Globals._gsQueue.pop()(); }
...
Alloy.Globals.TweenLite = Alloy.Globals.com.greensock.TweenLite;
